...
long long ln_fromBig(bigInt self); //return long long from bigInt if it possible, otherwise return -9223372036854775807

int ln_sign(bigInt self); // return -1 if bigInt < 0, else 1
